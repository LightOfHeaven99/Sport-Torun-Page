    ...
    <div class="d-flex justify-content-center">
      ...
      <?php if($this->session->userdata('is_admin') == 0) : ?>
            ...
            ?>
  			...
  			<div class="card-body">
          <?php if($this->session->userdata('display_login') == 0) : ?>
            <a href='changedisplaylogin?choice=1' style="color: #364FD2;">Zmień wyświetlanie na login</a></br> <!-- display_login 0->1 -->
          <?php else : ?>
            <a href='changedisplaylogin?choice=0' style="color: #364FD2;">Zmień wyświetlanie na imię i nazwisko</a></br> <!-- display_login 1->0 -->
          <?php endif; ?>
