 ...
 <div class="parallax-card">
	 ...
	 <div class="row justify-content-center">
			<div class="row" style="padding: 2rem;">
				<div class="row-sm-4"><center><h6 class="header"><img src="../assets/downloads/Schemat Logo.png" style="height: 50px; width: 50px;"></img><br> Drużyna Pierwsza</h6></center></div>
				<div class="row-sm-4"><center><h6 class="header"> : </h4></center></div>
				<div class="row-sm-4"><center><h6 class="header">Drużyna Druga <br><img src="../assets/downloads/Schemat Logo.png" style="height: 50px; width: 50px;"></img></h6></center></div>
			</div>
	 </div>
	</div>
</div>
