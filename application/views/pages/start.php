 ...
 <div class="parallax-card">
	 ...
	 <div class="row justify-content-center">
			<div class="row" style="padding: 2rem;">
				<div class="col-sm-4"><center><img src="../assets/downloads/Schemat Logo.png" style="height: 10%;"></img></center></div>
				...
				<div class="col-sm-4"><center><img src="../assets/downloads/Schemat Logo.png" style="height: 50px; width: 20px;"></img></center></div>
			</div>
	 </div>
	</div>
</div>
