      ...
      <div class="row">
        ...
        <br>
          <p align="justify"><input type="checkbox" id="myCheck" onclick="myFunction()" required> Zgadzam się z Polityką Prywatności<br>
            ...
            <br><font size="2.5">Pobierz i wypełnij <a href="../assets/downloads/Formularz zgłoszeniowy drużyny TLS.docx"><font color="#e6b800" size="2.5">formularz</font></a>, a gotowy zapisz do formatu <b>PDF</b>.</font></p>
